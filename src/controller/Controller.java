...
public class Controller {
     ...
     * 
     * @return string with info about item prices.
     */
    public String showVatForEveryItem(){
    ...
    public void completeSale() {
        Receipt receipt = new Receipt(sale.generateSaleDTO());
     ...
     * 
     * @return string message confirming that the transaction has been recorded.
     */
     ...
     * 
     * @return string message confirming that accounting has been notified.
     */
    public String notifyAccounting() {
     ...
     * 
     * @return string message confirming that inventory has been notified.
     */
    public String notifyInventoryRegistry() {
