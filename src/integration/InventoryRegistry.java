...
public class InventoryRegistry {
     ...
     * 
     * @return a string about information for the inventory system.
     */
    public String updateInventorySystem(ItemDTO item) {

        return "Decrease inventory for item " + item.getId() + " with " + item.getQuantity() + " units.";
    }
}
