...
public class Sale {
    ...
    /**
     * Displays a string with the price including VAT,
     * and VAT amount for the last scanned item.
     * 
     * @return string with total price details. 
     */
    public String displayItemPricesWithVat() {
        ItemDTO item = lastScannedItem;
            ...
            return "Total Price (including VAT): " + String.format("%.2f", item.getPrice().getAmount() * item.getQuantity()) +
